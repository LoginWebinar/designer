...
export default function ImageSetCard (props:ChildProps){
  ...
  return(
    <>
        ...
        <div className="w-[240px] md:w-[320px] p-2 h-full bg-stone-800 border border-gray-700 rounded-lg shadow">
          
          <ThumbnailCarousel thumbnails={props.imageCardData.thumbnails} />
          
          <div>
            <h3 className="text-sm font-medium truncate text-gray-100">{props.imageCardData.title}</h3>
            <p className="text-sm mt-2 italic truncate text-gray-300">{props.imageCardData.description}</p>            
